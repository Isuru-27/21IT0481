...
<head>
    ...
    <link href="conta1.css" rel="stylesheet">
</head>
...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/icn2.png" width="100px" height="100px" alt=""> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Your Choices <span class="sr-only"></span></a> </li>
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose Your Choices</h4> </div>
    ...
    <div class="section-header">
      <div class="container">
        <h2>Contact Us</h2>
        <p>Contact our customer services or send your comments as a message.</p>
      </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="contact-info">
          <div class="contact-info-item">
            ...
            <div class="contact-info-content">
              <h4>Address</h4>
              <p>25 Great Tower St,<br>London EC3R 5AQ,<br>United Kingdom</p>
            </div>
          </div>
      ...
      <br><br><br>
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30606.745074177314!2d-0.1535730857879485!3d51.50574255174856!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4876034de3b32737%3A0xe3ad23c0d38cc6be!2sSripur!5e0!3m2!1sen!2slk!4v1702848766616!5m2!1sen!2slk" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
  </section>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>25 Great Tower St, London EC3R 5AQ, United Kingdom</p>
                                    <h5>Phone: +442076211214</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Yummy Yummy Yummy</h5>
                                   <p>Chicken dinner is a winner.</p>
                                </div>
                    </div>
                </div>
